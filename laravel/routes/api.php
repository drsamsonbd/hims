...
|
*/
header('Access-Control-Allow-Origin:  https://his.hospbeluran.fastq.co');
...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::resource('activepatients', 'PKRCActiveController');
    Route::get('activepkrc', 'PKRCActiveController@showbyPKRC')->name('showbyPKRC');
    Route::group(['middleware' => 'admin'], function ($router) {

        Route::post('register', 'AuthController@register'); 

        Route::post('users/reset/{id}', 'UsersController@reset')->name('users.reset');
