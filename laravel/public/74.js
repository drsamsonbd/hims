...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getIC: function getIC() {
      var _this = this;

      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.$apiAdress + '/api/users/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token")).then(function (_ref3) {
        var data = _ref3.data;
        return _this.ic = data.ic;
    ...
    reset: function reset() {
      if (confirm("Do you really want to reset?")) {
        var self = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.$apiAdress + '/api/users/reset/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token"), {
          _method: 'POST',
          ic: self.ic
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.$apiAdress + '/api/users/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token")).then(function (response) {
      ...
      self.items = items.map(function (_ref4) {
                ...
                [
                  ...
                  _c("CForm", [
                    _c("input", {
                      ...
                      attrs: { type: "text", id: "InputIC", hidden: "" },
